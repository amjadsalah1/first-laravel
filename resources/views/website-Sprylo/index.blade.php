<x-layout title="home page">
    ...
    <div class="drawer" id="drawer" aria-hidden="true">
        ...
        <a href="cart.html" class="btn btn--indigo" style="margin-top:var(--s5); justify-content:center">View cart
            →</a>
    </div>
            ...
            <div class="container">
                ...
                <div class="products">
                    ...
                    <article class="product-card">
                        ...
                        <div class="price"><span class="now">$1,780</span><span class="was">$1,980</span>
                        </div>
